...
public class C02 {
    ...
    public static void main(String[] args) {
        ...
        String dosyaYolu = "src/main/java/day_17_praaaaaaaaaaaaaaaactice/dosya.txt";
        //file ye ulaşmak için dosya yolunu almamız gerek
        //bunun için txt filesinin üstüne sağ tık, copy path/reference, path from content root,
        //tırnak içindeki kısma ctrl v yaptık.

        //FileInputStream kızardı üzerine gelip signature tıkladık, main methodun yanına
        //throws FileNotFoundException  geldi
        //ama bunu istemediğimiz için kısmını silip try catch kullandık ve bunun için Code
        //seçeneğinden ekledik
