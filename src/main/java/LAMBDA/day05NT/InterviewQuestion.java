...
public class InterviewQuestion {
    //Example1:: Size verilen bir array'in "Mountain Array" olup olmadigini gosteren kodu yaziniz
    //Elemanlar bu cesit arrayde once artacak, belli bir elemana gelince o elemandan sonra azalacak.
    //[0,2,5,3,1,-2]
    public static void main(String[] args) {

        int[] arr={0,2,5,3,1,-2};
        //Array.i list.e dönusturelim, cünkü listi kullanmak daha kolay
        List<Integer> myList= new ArrayList<>();
        Arrays.stream(arr).forEach(t->myList.add(t));//Array.i list.e lambda ile ceviriyoruz.
        ...
        //Max. elemana kadarki tüm elemanlari bir list.in icine koy
        List<Integer> firstList= new ArrayList<>();
        myList.stream().filter(t->myList.indexOf(t)<=idxOfMax).forEach(t->firstList.add(t));
        System.out.println(firstList);

        ////Maksimum elemana kadarki tum elemanlarin bir kopyasini olustur.
        List<Integer> firstListCopy= new ArrayList<>();
        firstList.stream().forEach(t->firstListCopy.add(t));
        System.out.println(firstListCopy);

        //Kopyaladigimiz elemanlari sirala
        Collections.sort(firstListCopy);

        //Maksimum elemana kadarki tum elemanlar ile kopyasinin ayni olup olmadigini kontrol et
        ...
        Collections.sort(secondListCopy);//önce sirala sonra cevir
        ...
        System.out.println("Is the array mountain array? "+(rule1&&rule2));//true
