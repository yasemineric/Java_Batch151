...
import java.io.FileInputStream;// io==> input-outout- kütüphane gibi
...
public class E05 {
    public static void main(String[] args) throws IOException {
        ...
        //File, sag klick- copy path, reference, sag klick, path from content root yapip burada parantez icine atiyoruz.
        //Bu islemden sonra FileInputStream kismi kirmizi bir sekilde uyari verir, ya dosyayi bulamazsam diye.
        // Add Exception to method secerek methodun yanina "throws FileNotFoundException" ekleriz.

        int k=0;
        while((k=fis.read())!=-1){// burada read() kirmizi uyari verir.Add Exception to method secersek
            // yukaridaki "throws FileNotFoundException" ismi "throws IOException" ile degisti.
            //"throws IOException", "throws FileNotFoundException"nin Parent.idir.
            // read() methodu okunacak birsey kalmayinca -1 verir. Diger türlü karakterlerin ascii degerlerini verir.
            System.out.print((char) k);// type casting yapip (char) ekliyoruz, anlamsiz ascii degerleri
            //yerine caharacterleri yazdiriirz.
        }
