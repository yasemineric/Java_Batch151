...
public enum UsStatesEnum {
    ...
    private final String stateName;     //Yukaridaki Degiskenleri bu enum.in disinda kullanmayacagimiz
    // icin Private yapmaliyiz. Eyaletin ismi verileri degismeyecegi icin final yapiyoruz. Final olan elemanlar
    // degistirilmeyecegi icin biz Setter kullanamayiz, sadece Getter kullanip görebiliriz
...
State ismini verince State'in kisaltmasini veren bir method da olusturabiliriz.
     */
    UsStatesEnum(String stateName, String abbreviation, String capital) {// sag klick, generate, contructor,
        // 3.ü icin constructor olusturunca hata kalkar.
