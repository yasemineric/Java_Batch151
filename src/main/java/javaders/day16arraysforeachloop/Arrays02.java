...
public class Arrays02 {
    public static void main(String[] args) {
        ...
        2) Kullanicinin yapacagi islemi almaliyiz
        3) Kullanicidan iki sayi al,aliyiz
        4) Tekrar tekrar islem yapmak icin loop sec
         */
        ...
        do {
            ...
            //Bir variable'i {} arasinda olusturursaniz onun disinda kullanamazsiniz. Buna scope(kapsamak) denir.
            switch (opr) {
                case '+':
